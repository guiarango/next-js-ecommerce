        ...
        >
          <SwiperSlide>
            <div className={`${classes.category1} ${classes.categoryBanner}`}>
              <Link href="/category/1" className={classes.categoryTitle}>
                Accesories
              </Link>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className={`${classes.category2} ${classes.categoryBanner}`}>
              <Link href="/category/2" className={classes.categoryTitle}>
                Cellphones
              </Link>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className={`${classes.category3} ${classes.categoryBanner}`}>
              <Link href="/category/3" className={classes.categoryTitle}>
                Tablets
              </Link>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className={`${classes.category4} ${classes.categoryBanner}`}>
              <Link href="/category/4" className={classes.categoryTitle}>
                Computers
              </Link>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className={`${classes.category5} ${classes.categoryBanner}`}>
              <Link href="/category/5" className={classes.categoryTitle}>
                Tv's
              </Link>
            </div>
          </SwiperSlide>
